...
<title>handleForm</title>
		...
		<link rel="stylesheet" href="css/handleFormStyle2.css" />
		...
		<script src="js/handleForm2.js"></script>
</head>
<body>
<!-- WRAPPER -->
		<div id="wrapper">
		...
		<div class="center">
			...
			<div class="slider-box">
				<div class="slider-area">
					...
					<div class="slider-cell">
						<img src="images/guanggao9.jpg">
					</div>
					<div class="slider-cell">
						<img src="images/guanggao10.jpg">
					</div>
				</div>
			</div>
			<!--END 轮播图-->
				...
				<div class="nav-box">
					<div class="find_nav">
						<div class="find_nav_left">
							<div class="find_nav_list" style="left: 37%;">
								<ul>
									<li class="find_nav_cur"><a href="seeWorksRandomlyForm.html">随机查看</a></li>
									<li><a href="viewLatestWorksForm.html">查看最新</a></li>
									<li><a href="seeListOfWorksFabulousForm.html">查看排行</a></li>
								</ul>
							</div>
						</div>
					</div>
