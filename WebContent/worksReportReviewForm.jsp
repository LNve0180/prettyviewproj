...
<head>
<meta charset="UTF-8">
<title>worksReportReviewForm</title>
		<!-- VENDOR CSS -->
		...
		<script src="js/worksReportReview.js" type="text/javascript"></script>
</head>
<body>
<!-- WRAPPER -->
		<div id="wrapper">
				...
				<div class="sidebar-scroll">
					<nav>
						<ul class="nav">
							...
							<li><a href="worksReportReviewForm.jsp" class="active"><i class="lnr lnr-alarm"></i> <span>审核被举报作品</span></a></li>
			...
			<div class="main">
				...
				<div class="main-content">
					<div class="container-fluid">
						...
						<div class="panel panel-headline">
							<div class="panel-heading">
								<label>待审核列表  总共<span class="reportNum">0</span>条</label>
							</div>
