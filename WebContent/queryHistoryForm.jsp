...
<title>queryHistoryForm</title>
		...
		<script src="js/historyForm.js"></script>
		...
		<div class="center">
			...
			<div class="main-body">
				<div class="panel panel-headline">
					<!--BEGIN CONTAINER-->
					<div class="container slimScrollDiv">
						...
						<div class="main">
							...
							<div class="search-null" style="display: none;">
								<div class="show-msg-box" style="height: 250px;width: 300px;margin: 0 auto;">											
									...
									<span class="null-tip" style="width: 300px;height: 50px;"><p>没有查询到符合的内容请到首页去找找您喜欢的作品吧ヽ(✿ﾟ▽ﾟ)ノ</p></span>
								</div>
							</div>
							<!-- END 查询为空的时候显示-->
						</div>
